...
1. **Q: How do I measure backup power readiness?**
A: Start with watt-hours (Wh) for runtime, then confirm inverter surge needs and real-world derates. We cover the "the number everyone gets wrong" logic here: [the number everyone gets wrong when buying a solar generator](https://www.solarcurrents.co/notes/the-number-everyone-gets-wrong-when-buying-a-solar-generator/).

2. **Q: Why do backup systems fail during installation, not outages?**
A: Compliance and inspection issues. If you want fewer dead-end calls, reference the practical checklist for solar + battery projects: [AHJ Inspection Checklist for Solar + Battery Systems](https://www.solarcurrents.co/notes/ahj-inspection-checklist/).

3. **Q: What's the real risk when outdoor solar is partially shaded?**
A: One shaded cell can crush your whole panel's output due to series-connected behavior. For the explanation, see [one shaded cell can kill your whole panel's output](https://www.solarcurrents.co/notes/one-shaded-cell-can-kill-your-whole-panels-output/).
...
For the plain-English overview that often reduces "surprise" conversations, use [NEC codes for solar and energy systems — a plain English guide](https://www.solarcurrents.co/notes/nec-codes-explained/).

> **Did You Know?**
> U.S. electricity customers experienced an average of 11 hours of electricity interruptions in 2024.
> Source: [U.S. Energy Information Administration (EIA) — Today in Energy](https://www.eia.gov/todayinenergy/detail.php?id=66744)
...
1. **What you can run.** List common loads by wattage range (fridge, lights, router, medical device, microwave, etc.).
2. **How long you can run it.** Convert capacity to runtime using real-life losses, not ideal numbers.
3. **What changes the outcome.** Shade patterns, dew factor, cloudy days, inverter efficiency, and startup surges.
...
And when buyers compare systems, they keep misreading the same spec. We address that directly in [the number everyone gets wrong when buying a solar generator](https://www.solarcurrents.co/notes/the-number-everyone-gets-wrong-when-buying-a-solar-generator/), because battery capacity, runtime, and inverter size are where reality diverges from ads.
...
For installers and designers who want a clean checklist to base marketing conversations on, reference [AHJ Inspection Checklist for Solar + Battery Systems](https://www.solarcurrents.co/notes/ahj-inspection-checklist/).

If you need a broader code framework before you answer customer questions, the same site has [NEC codes for solar and energy systems — a plain English guide](https://www.solarcurrents.co/notes/nec-codes-explained/), including NEC 690, 705, 706, and 750. That combination helps you talk backup power readiness without sounding like you are reciting legalese.
...
If your marketing is talking battery storage and solar generation together, it should mention that RV systems are subject to different setup expectations than a house. Use [NEC codes for solar and energy systems — a plain English guide](https://www.solarcurrents.co/notes/nec-codes-explained/) to keep your descriptions anchored.
...
For shade behavior, use [one shaded cell can kill your whole panel's output](https://www.solarcurrents.co/notes/one-shaded-cell-can-kill-your-whole-panels-output/) as your reference point.
...
If you do this right, you reduce buyer mismatch. The "battery capacity, runtime, and inverter size" misunderstanding is exactly the one covered in [the number everyone gets wrong when buying a solar generator](https://www.solarcurrents.co/notes/the-number-everyone-gets-wrong-when-buying-a-solar-generator/).
...
> State interruptions dwarfed the US average and the prior decade's normal.
> *South Carolina hit with 53 hours of outages in 2024 — data from [U.S. EIA — Today in Energy](https://www.eia.gov/todayinenergy/detail.php?id=66744)*
...
> **Did You Know?**
> Customers in South Carolina experienced longer service interruptions than in any other state, at nearly 53 hours in 2024.
> Source: [U.S. Energy Information Administration (EIA) — Today in Energy](https://www.eia.gov/todayinenergy/detail.php?id=66744)
