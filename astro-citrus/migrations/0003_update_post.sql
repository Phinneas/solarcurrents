UPDATE posts SET title = 'Solar Panel Efficiency Ratings: What the Spec Sheet Number Actually Means', description = 'Lab cells hit 47.6% efficiency. The panel you can actually buy tops out around 23% — and delivers less than that on your roof. Here''s what STC, PTC, and NOCT ratings measure, and when the efficiency premium is worth paying.', content = 'A manufacturer''s spec sheet says 22.8% efficiency. A lab in Germany just set a record at 47.6%. Neither number tells you what your roof will actually produce, and the gap between them is bigger than most buying guides let on.
